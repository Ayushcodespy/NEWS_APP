                  ...
                  return Stack(
                    children: [
                      ...
                      Positioned(
                        ...
                        child: VxBox(
                          ...
                          children: [
                            ...
                            6.widthBox,
                            const Text("255", style: TextStyle(color: AppColors.white,),),
                          ],
                        ))
                            .padding(const EdgeInsets.symmetric(
                                horizontal: 12, vertical: 6))
                      ...
                      Positioned(
                        ...
                        child: Column(
                          children: [
                            Text("Our Efforts to Build the Internet We believe the Internet paves the way for people and communities to thrive.".allWordsCapitilize(),
                            style: const TextStyle(color: AppColors.white),),
                            Row(children: [
                              const Icon(Icons.access_time, size: 14, color: AppColors.white),
                              5.widthBox,
                              const Text("20 April, 24", style: TextStyle(fontSize: 12, color: AppColors.white),)
                            ],)
                          ],
                        ),
